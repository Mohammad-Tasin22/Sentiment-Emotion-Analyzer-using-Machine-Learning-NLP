...
<h3><b>How It Works</b>
   ...
   - Feature Extraction – Transform text into numerical features using:
...
<h3><b>Model Training – Train models to classify emotions using:</b>
   ...
   - Prediction – Input text is converted into features and the trained model predicts the emotion.
